...
export const GitHubDoc = () => {
  ...
  return (
    <div>
      <Note>
        📡 This content is dynamically loaded from the [Kodosumi GitHub repository](https://github.com/masumi-network/kodosumi/blob/main/docs/deploy.md) and updates automatically.
      </Note>
      <div 
        style={{ 
          lineHeight: '1.6',
