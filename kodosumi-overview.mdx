...
try {
const response = await fetch('https://api.github.com/repos/masumi-network/kodosumi/contents/docs/what-is-kodosumi.md?ref=docs-prepare-for-mintlify');
...
<div>
  <Note>
    ...
    <a
      href="https://github.com/masumi-network/kodosumi/blob/docs-prepare-for-mintlify/docs/what-is-kodosumi.md"
      target="_blank"
